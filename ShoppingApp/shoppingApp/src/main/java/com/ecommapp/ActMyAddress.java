...
public class ActMyAddress extends BaseActivity {

    String TAG = "==ActMyAddress==";
    //
    ...
    protected void onCreate(Bundle savedInstanceState) {
        try {
            ...
            //
            ViewGroup.inflate(this, R.layout.act_my_address, llContainerSub);
            App.showLogTAG(TAG);
    ...
    private void initialisation() {
        try
        {
            ...
            tvTitle.setText(App.PROFILE_MAIN_MY_ADDRESS);
    ...
    private void setClickEvents() {
        try {
            ...
            fabAdd.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent iv = new Intent(ActMyAddress.this, ActAddAddress.class);
                    iv.putExtra(App.ITAG_FROM, "ActMyAddress");
                    App.myStartActivity(ActMyAddress.this, iv);
                }
            });
    ...
    public void onBackPressed() {
        //super.onBackPressed();
        App.myFinishActivity(ActMyAddress.this);
    }
}
