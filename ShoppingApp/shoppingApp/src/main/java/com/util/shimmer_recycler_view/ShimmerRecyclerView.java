...
package com.util.shimmer_recycler_view;
...
/**
 * Created by dhaval.mehta on 22/11/16.
 */
...
public class ShimmerRecyclerView extends RecyclerView {
    ...
    private int mLayoutReference = R.layout.shimmer_recycler_view_layout_sample_view;
    ...
    private void init(AttributeSet attrs) {
        ...
        try
        {
            if (a.hasValue(R.styleable.ShimmerRecyclerView_shimmer_demo_layout)) {
                setDemoLayoutReference(a.getResourceId(R.styleable.ShimmerRecyclerView_shimmer_demo_layout, R.layout.shimmer_recycler_view_layout_sample_view));
            }
            ...
            mShimmerColor = a.getColor(R.styleable.ShimmerRecyclerView_shimmer_demo_shimmer_color, getColor(R.color.clrShimmerColor));
